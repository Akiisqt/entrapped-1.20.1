...
public class Barrel extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public static final Map<Item, Object> barrelRecipes = new HashMap<>();
    static {
        //barrelRecipes.put(Items.GUNPOWDER, );
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (state.get(sealed) && player.getStackInHand(hand).isEmpty() && player.isSneaking()) {
